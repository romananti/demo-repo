...
public final class Point implements Comparable<Point> {
    ...
    /**
     * This method compares this current point object to another Point object.
     * Returns 1 if greater, 0 if equal and -1 if this object is less.
     */
    public int compareTo(final Point theOtherPoint) {
        if (this.equals(theOtherPoint)) {
            return 0;
        } else if (this.getX() > theOtherPoint.getX() && this.getY() > theOtherPoint.getY()) {
            return 1;
        } else {
            return -1;
        }
